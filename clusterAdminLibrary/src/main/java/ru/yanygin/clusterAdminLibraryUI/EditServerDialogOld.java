...
public class EditServerDialogOld extends Dialog {
...
//	private Text txtManagerPort;
	 ...
	 * @param serverParams 
	 */
	public EditServerDialogOld(Shell parentShell, Server serverParams) {
		super(parentShell);
...
//		txtManagerPort.setToolTipText("manager port");
	...
	private void initServerProperties() {
		if (serverParams != null) {
			...
			this.txtManagerHost.setText(serverParams.agentHost);
...
//			this.txtManagerPort.setText(serverParams.getManagerPortAsString());
			...
			this.comboV8Versions.setText(serverParams.localRasPath);
