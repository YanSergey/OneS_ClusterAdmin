...
public class AuthenticateDialog extends Dialog {
   ...
   * @param authDescription - authenticate description
   * @param authExcpMessage - authenticate exception message
   */
  public AuthenticateDialog(
      Shell parentShell, String username, String authDescription, String authExcpMessage) {
    super(parentShell);
