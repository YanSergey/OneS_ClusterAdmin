...
/** Extend info for working process. */
public class WorkingProcessInfoExtended implements IInfoExtended {
  ...
  private static final String TITLE_MEMORY_EXCEEDED =
      Messages.getString("WPInfo.MemoryExceeded"); //$NON-NLS-1$
  private static final String TITLE_AVAILABLE_PERFORMANCE =
      Messages.getString("WPInfo.AvailablePerformance"); //$NON-NLS-1$
  ...
  private static final String TITLE_CONNECTIONS_COUNT =
      Messages.getString("WPInfo.ConnectionsCount"); //$NON-NLS-1$
  private static final String TITLE_BACK_CALL_TIME =
      Messages.getString("WPInfo.BackCallTime"); //$NON-NLS-1$
  private static final String TITLE_SERVER_CALL_TIME =
      Messages.getString("WPInfo.ServerCallTime"); //$NON-NLS-1$
  private static final String TITLE_DB_CALL_TIME =
      Messages.getString("WPInfo.DBCallTime"); //$NON-NLS-1$
  private static final String TITLE_CALL_TIME =
      Messages.getString("WPInfo.CallTime"); //$NON-NLS-1$
  private static final String TITLE_LOCK_CALL_TIME =
      Messages.getString("WPInfo.LockCallTime"); //$NON-NLS-1$
  private static final String TITLE_CLIENT_THREADS =
      Messages.getString("WPInfo.ClientThreads"); //$NON-NLS-1$
  ...
  /**
   * Create extended info for working process.
   *
   * @param server - server
  ...
  public String[] getExtendedInfo() {
    ...
    // license
    var license =
        workingProcess.getLicense().isEmpty()
            ? "" //$NON-NLS-1$
            : workingProcess.getLicense().get(0).getFullPresentation();
